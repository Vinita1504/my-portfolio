...
export default function Experience() {
  ...
  return (
    <InteractiveBackground className="min-h-screen py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-1000 ${
          ...
          <div className="flex items-center justify-center space-x-3 mb-4 sm:mb-6">
            ...
            <span className="text-xs sm:text-sm text-accent font-semibold">Professional journey</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="lg:col-span-1 order-1">
            <div 
              ...
              style={{
                transform: `lg:translateY(${Math.min(scrollY * 0.3, 400)}px)`
              }}
            >
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <div className="mb-2">
                        <h4 className="text-lg sm:text-xl font-bold text-foreground mb-1">{exp.title}</h4>
                      ...
                      <p className="text-muted-foreground mb-3 leading-relaxed text-xs sm:text-sm">{exp.description}</p>
          ...
          <div className="lg:col-span-2 order-1 lg:order-2">
            <div className="space-y-6 sm:space-y-8">
              {education.map((edu, index) => (
                ...
                >
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold text-foreground mb-2">{edu.institution}</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mb-1">{edu.degree}</p>
